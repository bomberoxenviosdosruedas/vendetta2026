...
import { Clock, PlusCircle, Ban, Info, Loader2, Package, Wind } from "lucide-react"
                        ...
                        <div className="flex flex-wrap gap-x-4 gap-y-2 items-center">
                            <div className="flex flex-col gap-2 text-sm flex-grow">
                                <div className="grid grid-cols-2 gap-1 text-xs">
                                    ...
                                    <div className="flex items-center gap-2" title="Capacidad">
                                        <Package className="h-4 w-4" />
                                        <span>{formatNumber(troop.capacidadActual)}</span>
                                    </div>
                                    <div className="flex items-center gap-2" title="Velocidad">
                                        <Wind className="h-4 w-4" />
                                        <span>{formatNumber(troop.velocidadActual)}</span>
                                    </div>
                                </div>
