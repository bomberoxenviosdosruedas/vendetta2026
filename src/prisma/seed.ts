...
async function main() {
  ...
  console.log('🏋️ Asignando entrenamientos iniciales al usuario...');
  for (const trainingId of trainingConfigIds) {
  ...
  console.log('✅ Usuario, progreso, habitaciones y entrenamientos iniciales cargados.');
}
