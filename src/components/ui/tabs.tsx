...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "v-tabs-list items-center justify-center",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "v-tab inline-flex items-center justify-center whitespace-nowrap disabled:pointer-events-none disabled:opacity-50",
      className
    )}
    {...props}
  />
